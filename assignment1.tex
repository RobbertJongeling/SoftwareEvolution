...
We see a few pairs of requirements depending on eachother. In two cases, this is because it is the same requirement, this concerns the pairs 26,58 and 3,16. In the other cases, it concerns requirements that are closely realted. We see one small loop in the graph, between requirements 56,57 and 58. This concerns requirements about the organization and arrangement of the content. Which needs to adhere to these three requirements. This is a bit of a strange part as especially requirements 56 and 57 seem to contradict eachother. This may be a problem when requirements evolve.

The global functionality partition as created in the requirements document can still be seen in the graph. For example, the ``VEMUS Visualizations'' part is clearly seperated from other requirements with only few relations to other parts of the system. The parts about teacher-student feedback and providing feedback are a lot more intertwined. 

\subsection{Implications on requirements evolution}
In the search of ambiguous requirements, we found requirements 14,17,26,36,40 and 45 to be in some way ambiguous. We could have also mentioned requirement 58 but as said before, 26 and 58 are the same requirement. In the graph we see that 58 is part of the cycle 56,57 and 58 of which we already noted that this is a strange construct and so a point of attention concerning requirements evolution.
...
We would recommend to define rules which each visualization has to adhere to. This will resolve this ambiguity and make the overall system more capable of coping with evolution of the requirements.
