...
An interesting thing to notice with respect to the \texttt{nekohtml-developer} mailing list (which is primarily used to share patches and bug reports) is that it became active for the first time in December of 2007, when v0.9.5 was first released.
