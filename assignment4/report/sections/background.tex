...
In the case of Travis, building `frequently' is every time a change is pushed to (any branch of) the repository on GitHub or when someone issues a pull request.
