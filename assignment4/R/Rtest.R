...
f <- function(r) {
	...
	cat(paste(r["owner"], r["name"], pofchisq, res[1,1], res[1,2], res[2,1], res[2,2], oddsRatio, pValue, sep=","), file="D:\\Documents\\github\\SoftwareEvolution\\assignment4\\R\\Routputtest.csv", append = T, fill = T)
}
